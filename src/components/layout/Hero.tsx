...
export function Hero() {
  return (
    <section
      id="inicio"
      className="min-h-screen bg-gradient-to-br from-purple-900 via-slate-900 to-teal-900 flex items-center justify-center px-4 pt-24"
    >
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:grid md:grid-cols-2 gap-12 items-center">
        <motion.div
          className="text-white flex flex-col items-center text-center md:text-left md:items-start space-y-9"
